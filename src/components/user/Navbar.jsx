...
export default function Navbar() {
  ...
  // this query we are getting from 'AppSearchForm'
  const handleSearchSubmit = (query) => {
    // navigate to search movie route with query as a title of movie, that will send backend request to get the matched results
