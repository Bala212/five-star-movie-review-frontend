  ...
  return (
    <nav className="w-48 min-h-screen bg-secondary border-r border-gray-300">
      <div className="flex flex-col justify-between pl-5 h-screen sticky top-0">
        ...
        <div className=" pl-9 flex flex-col item-start pb-5">
...
const NavItem = ({ children, to }) => {
  ...
  return (
    //whenever this Link is active it will callback the function written in className i.e
    //we are using that className properties when thr link is active
    <NavLink
      className={({ isActive }) =>
